...
import { cadastrarAdmPadrao } from './src/controllers/controllers_adm.js'
...
app.get('/cadastro', (req, res) => {
    res.sendFile(
        path.resolve('./src/public/html/administrador/cadastro_usuario.html')
    )
})
